...
describe('dateRangeFor', () => {
	...
	it('does not shift the start date across a UTC day boundary', () => {
		// A UTC round-trip (toISOString) would have pulled this back an extra calendar day in a
		// positive-offset timezone; the local-date arithmetic must not do that.
